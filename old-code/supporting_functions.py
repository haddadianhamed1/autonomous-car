...
def update_rover(Rover, data):
      ...
      print("length of data position {}".format(data["position"]))
...
def create_output_images(Rover):
      ...
      if rock_world_pos[0].any():
            ...
            for idx in range(len(Rover.samples_pos[0])):
                  ...
                  # sample on the map
                  if np.min(rock_sample_dists) < 5:
                        samples_located += 1
                        Rover.samples_located1 = 1
#                        Rover.near_sample = 1
                        map_add[test_rock_y-rock_size:test_rock_y+rock_size,
                        test_rock_x-rock_size:test_rock_x+rock_size, :] = 255
#                  else:
#                        Rover.samples_located1 = 0
      ...
      cv2.putText(map_add,"hamed: "+str(np.round(Rover.total_time, 1))+' s', (0, 10),
      ...
      cv2.putText(map_add,"  Located: "+str(samples_located), (0, 70),
                  cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
      cv2.putText(map_add,"  Collected: "+str(Rover.samples_located1), (0, 85),
                  cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
